...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}>
      <body className="flex min-h-full flex-col text-slate-800 selection:bg-indigo-300/30 selection:text-indigo-900 bg-gradient-to-br from-indigo-50 via-white to-cyan-50 bg-fixed">
